...
usage() {
  cat <<'EOF'
Usage:
  ./open_training_capture_over_ssh.sh --host USER@HOST [options] -- [capture_flir_training_frames.py args...]
...
Any arguments after -- are passed directly to DeepLabCut/Tests/capture_flir_training_frames.py.
Saved frames are written on the remote eye-tracking computer, under
...
echo "Opening forwarded FLIR training-frame capture from ${HOST}..."
